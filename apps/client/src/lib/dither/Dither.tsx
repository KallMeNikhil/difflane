...
class RetroEffectImpl extends Effect {
  ...
  constructor({ colorNum = 4.0, pixelSize = 2.0 }: RetroEffectProps = {}) {
...
const RetroEffectComponent = forwardRef<typeof RetroEffectImpl, RetroEffectProps>((props, ref) => {
  const { colorNum, pixelSize } = props;
  return <WrappedRetroEffect ref={ref} colorNum={colorNum} pixelSize={pixelSize} />;
});
RetroEffectComponent.displayName = "RetroEffect";
    ...
    <>
      <mesh ref={mesh} scale={[viewport.width, viewport.height, 1]}>
        ...
        <shaderMaterial
          ...
          uniforms={waveUniformsRef.current as unknown as Record<string, THREE.IUniform>}
        />
      </mesh>

      <EffectComposer>
        <RetroEffectComponent colorNum={colorNum} pixelSize={pixelSize} />
      </EffectComposer>
